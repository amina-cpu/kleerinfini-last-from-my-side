...
class Command(BaseCommand):
    help = 'Populate database with Algerian products test data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('Creating Algerian products...')
        ...
        products_data = [
            {
                ...
                'images': ['image30'],  # Maps to image31
                'est_pret': True,
            ...
            },
            {
                ...
                'images': ['image31'],  # Maps to image30
                'est_pret': True,
                'region_org': 'Algérie',
                'langue_du_product': 'Français',
